...
from ADD import music

from ADD import print_level

from ADD import printer_final
...
def end_game():
   ...
   sleep(2)
   stdscr.clear()
   printer_final(HEIGHT, WIDTH, stdscr,snake,name)
   stdscr.refresh()
   sleep(3)
...
while(True):
    ...
    if  newHead==food:
        ...
        print_level(HEIGHT,WIDTH,stdscr,score)
